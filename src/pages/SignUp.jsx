        ...
        <div className="xl:p-24 sn:p-16 p-6 space-y-6">
          ...
          <div className="text-gray-700 space-y-4">
            <div className="flex items-center sm:justify-start justify-center gap-4 lg:pr-40">
              <div className={`cursor-pointer p-2 px-4 flex rounded-lg items-center justify-start gap-3 w-full ${!isBusiness ? ' bg-gradient-to-r from-[#F7A738] to-[#F33F41]  text-white' : ' border-[#F33F41] border'}`} onClick={() => setIsBusiness(false)}>
              ...
              <div className={`p-2 px-4 flex rounded-lg items-center justify-start gap-3 cursor-pointer w-full${!isBusiness ? ' border-[#F33F41] border' : ' bg-gradient-to-r from-[#F7A738] to-[#F33F41]  text-white'}`} onClick={() => setIsBusiness(true)}>
